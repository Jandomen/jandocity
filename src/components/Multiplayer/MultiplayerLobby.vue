...
<template>
  <div class="absolute inset-0 z-30 flex flex-col bg-[#0a0f1e] text-white overflow-hidden p-4">
    ...
    <div class="absolute inset-0" style="background: radial-gradient(ellipse at 50% 0%, rgba(168,122,248,0.18), transparent 60%), radial-gradient(ellipse at 50% 100%, rgba(56,189,248,0.12), transparent 50%);"></div>
    <div class="relative flex-1 flex flex-col max-w-[560px] w-full mx-auto gap-4 overflow-auto">
